<div id="start-screen">
    ...
    @foreach($sliders as $index => $slider)
        @if($slider->type==1)
        <li id="slide_{{++$index}}" class="@if($index==1){{ 'selected' }}@endif" style="background-image: url(@if( strpos($slider->featured_image, 'http://') === false && strpos($slider->featured_image, 'https://') === false){{ asset($slider->featured_image) }}@else{{ $slider->featured_image }}@endif);">
        ...
        <li id="slide_{{++$index}}" class="@if($index==1){{ 'selected' }}@endif bg-video" style="background-image: url(@if( strpos($slider->featured_image, 'http://') === false && strpos($slider->featured_image, 'https://') === false){{ asset($slider->featured_image) }}@else{{ $slider->featured_image }}@endif);">
            <div class="full-width">
                <div class="container">
                    <div class="s-align">
                        <div>
