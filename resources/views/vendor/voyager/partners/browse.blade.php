                                    ...
                                    @foreach($dataType->browseRows as $row)
                                        <td>
                                            ...
                                            @if($row->field == 'company_logo')
                                                <img src="@if( strpos($data->company_logo, 'http://') === false && strpos($data->company_logo, 'https://') === false){{ asset($data->company_logo) }}@else{{ $data->company_logo }}@endif" style="width:100px">
